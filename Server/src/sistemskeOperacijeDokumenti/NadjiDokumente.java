 ...
 * @author stefa
 */
public class NadjiDokumente extends OpstaSistemskaOperacija {
    ...
    public ServerskiObjekat izvrsiOperaciju(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            if (lista.isEmpty()) {
                ...
                transferObjekat.setPoruka("Sistem ne moze da nadje dokumente po zadatoj vrednosti");
            } else {
                transferObjekat.setUspesno(true);
                transferObjekat.setPoruka("Pronadjeni su dokumenti po zadatoj vrednosti!");
            }
        } catch (SQLException ex) {
            //Logger.getLogger(VratiListuKlijenata.class.getName()).log(Level.SEVERE, null, ex);
            throw new Exception("Sistem ne moze da nadje dokumente po zadatoj vrednosti");
        }
