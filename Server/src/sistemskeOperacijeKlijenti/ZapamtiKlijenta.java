 ...
 * @author stefa
 */
public class ZapamtiKlijenta extends OpstaSistemskaOperacija {
    ...
    public ServerskiObjekat izvrsiOperaciju(OpstiDomenskiObjekat odo) throws Exception {
        ...
        try {
            ...
            transferObjekat.setPoruka("Klijent je uspesno zapamcen!");
        } catch (SQLException ex) {
            Logger.getLogger(ZapamtiKlijenta.class.getName()).log(Level.SEVERE, null, ex);
